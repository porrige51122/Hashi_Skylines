...
function onTouchEnd ()          { clicking = false; }
...
/**
 * Creates an easy way to translate keyboard keys' numbers to actual names.
 */
class KeyboardInput {
  constructor() {
  ...
  /**
   * Creates a function to simplify the up and Down handlers of key presses
   * @param keyCode The number allocated to the key.
   * @returns {{}} Key Object
   */
  keyboard(keyCode) {
    let key = {};
